...
<main class="suburbPage">
    <section class="introduction bg-dark-grey py-6">
        <div class="container">
            ...
            <p class="text-white highlight-primary font-poppins fs-30 fs-md-48 fw-600 text-center pt-7 pt-md-10">The Granny Flat <span>Approval Process</span></p>
            ...
            <div class="row text-white py-4 py-md-5 border-bottom border-grey">
                <div class="col-6">
                    <p class="fs-18 fs-md-25 fs-lg-30">Commitment</p>
                </div>
                <div class="col-6">
            ...
            <div class="row text-white py-4 py-md-5 border-bottom border-grey">
                <div class="col-6">
                    <p class="fs-18 fs-md-25 fs-lg-30">Professionalism</p>
                </div>
                <div class="col-6">
                    <article class="lh-1_67 fs-14 fs-md-16 fs-lg-18">
            ...
            <div class="row text-white py-4 py-md-5 border-bottom border-grey">
                <div class="col-6">
                    <p class="fs-18 fs-md-25 fs-lg-30">Seamless delivery</p>
                </div>
                <div class="col-6">
                    <article class="lh-1_67 fs-14 fs-md-16 fs-lg-18">
                        <p>From the start of the construction to the final fit-out of your granny flat in <?= the_title() ?> our team will deliver the highest quality finishes to exceed all expectations.</p>
                    </article>
                </div>
            </div>
    ...
    <section class="process bg-dark-grey py-6 py-md-8">
        <div class="container">
            <p class="fs-30 fs-md-48 lh-1 font-poppins fw-600 text-white highlight-primary text-center">Process for granny flats <span>in <?= the_title() ?></span></p>

            <article class="col-xl-10 mx-auto text-center description text-grey fs-18 lh-1_67 pt-4 pt-md-5">
                <p>Adding a granny flat in <?= the_title() ?> can be pricy so its important to work close with a company that will deliver the quality you require. At 5 Star we have high-quality standards and have tried and tested many materials on our projects to get to where we are.</p>
            </article>
            ...
            <div class="row g-4 mt-4">
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="processCard bg-white rounded-7 h-100 d-flex flex-column align-items-center text-center px-3 px-md-6 py-4 py-md-5">
                        ...
                        <p class="text-grey fs-14 fs-md-18 lh-1_67">is about qualifying your land in <?= the_title() ?> to ensure it is eligible for a granny flat build.</p>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-xl-6">
                    <div class="aboutCard position-relative overflow-hidden h-100 d-flex justify-content-center align-items-center">
                        <img class="image h-100 w-100 opacity-10 object-fit-cover position-absolute top-0" src="<?= get_template_directory_uri() ?>/assets/images/lib/floorplan.jpg" alt="">

                        <div class="col-11 col-xl-8 py-7 py-md-12">
                            <p class="text-white highlight-primary fs-30 fs-md-38 fw-600 lh-1">Why Choose <span>5 Star Granny Flat</span> Builders <?= the_title(); ?></p>
        ...
        <div class="container">
            ...
            <div class="row justify-content-between pt-3">
                ...
                <div class="col-auto d-none d-md-block">
                    <a href="<?= home_url() ?>/faq" class="btn btn-black rounded-10 text-white px-4">View All FAQ's</a>
                </div>
            </div>
