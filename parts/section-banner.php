...
<section class="banner py-5 position-relative">
    <?php if (!empty($banner['banner_image']['url'])) : ?>
        <img class="d-none d-xl-block position-absolute bottom-0 end-0 h-100" src="<?= $banner['banner_image']['url'] ?>" alt="<?= $banner['banner_image']['alt'] ?>">

    <?php elseif (is_page_template('page-templates/suburb.php')) : ?>
        <img class="d-none d-xl-block position-absolute bottom-0 end-0 h-100" src="<?= get_template_directory_uri() ?>/assets/images/background/suburb-banner.png" alt="">
    <?php elseif (is_home()) : ?>
        <img class="d-none d-xl-block position-absolute bottom-0 end-0 h-100" src="<?= get_template_directory_uri() ?>/assets/images/background/blogs-banner.png" alt="">
    <?php else : ?>
        <img class="d-none d-xl-block position-absolute bottom-0 end-0 h-100" src="<?= get_template_directory_uri() ?>/assets/images/background/banner.png" alt="">
    <?php endif; ?>
